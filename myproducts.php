						...
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="gallery.html" class="active">Gallery</a></li>
								   <div style="float: right; cursor: pointer; padding-top:30px; padding-left:30px;">
        <span class="glyphicon glyphicon-shopping-cart my-cart-icon"><span class="badge badge-notify my-cart-badge"></span></span>      </div>
							</ul>
						</nav>
					</div>
					<!--/.navbar-collapse-->
...
<section class="portfolio-agileinfo gallery" id="portfolio">
	...
	<div class="gallery-grids">
      ...
      <button class="btn btn-danger my-cart-btn" data-id="1" data-name="product 1" data-summary="summary 1" data-price="10" data-quantity="1" data-image="images/img_1.png">Add to Cart</button>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="images/g2.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
							 ...
							 <br>
      product2 - <strong>$20</strong>
      <br>
      <button class="btn btn-danger my-cart-btn" data-id="2" data-name="product 2" data-summary="summary 1" data-price="20" data-quantity="1" data-image="images/img_1.png">Add to Cart</button>
						</div>
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="images/g3.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
							 ...
							 <br>
      product3 - <strong>$30</strong>
      <br>
      <button class="btn btn-danger my-cart-btn" data-id="3" data-name="product 3" data-summary="summary 1" data-price="30" data-quantity="1" data-image="images/img_1.png">Add to Cart</button>
						</div>
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="images/g4.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
							 ...
							 <br>
      product4 - <strong>$40</strong>
      <br>
      <button class="btn btn-danger my-cart-btn" data-id="4" data-name="product 4" data-summary="summary 1" data-price="40" data-quantity="1" data-image="images/img_1.png">Add to Cart</button>
						</div>
					...
					<div class="tab_img">
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="images/g5.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
							 ...
							 <br>
      product5 - <strong>$50</strong>
      <br>
      <button class="btn btn-danger my-cart-btn" data-id="5" data-name="product 5" data-summary="summary 1" data-price="50" data-quantity="1" data-image="images/img_1.png">Add to Cart</button>
						</div>
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="images/g6.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
							 ...
							 <br>
      product6 - <strong>$60</strong>
      <br>
      <button class="btn btn-danger my-cart-btn" data-id="6" data-name="product 6" data-summary="summary 1" data-price="60" data-quantity="1" data-image="images/img_1.png">Add to Cart</button>
						</div>
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
      ...
      product7 - <strong>$10</strong>
      <br>
      <button class="btn btn-danger my-cart-btn" data-id="7" data-name="product 7" data-summary="summary 1" data-price="70" data-quantity="1" data-image="images/img_1.png">Add to Cart</button>
						</div>
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="images/g7.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
							 ...
							 <br>
      product8 - <strong>$10</strong>
      <br>
      <button class="btn btn-danger my-cart-btn" data-id="1" data-name="product 8" data-summary="summary 1" data-price="80" data-quantity="1" data-image="images/img_1.png">Add to Cart</button>
						</div>
 ...
 <script src="js/jquery-2.2.3.min.js"></script>
  ...
  $(function () {
    ...
    $('.my-cart-btn').myCart({
      ...
      numberOfDecimals: 2,
      cartItems: [
        {id: 1, name: '<input type="text" name="pname" value="product1">', summary: 'summary 1', price: 10, quantity:'<input type="text" name="pqty" value="1">', image: 'images/img_1.png'},
